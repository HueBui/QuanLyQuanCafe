...
@WebServlet(urlPatterns = {"/admin-total-by-month"})
public class AdminTotalMonthController extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rdAdmin = request.getRequestDispatcher("/views/admin/total/total-by-month.jsp");
